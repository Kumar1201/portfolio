...
document.addEventListener('keydown', e => {
  if (e.key === 'Escape') { closeProfilePreview(); return; }
...
const PROFILES = {
  github: {
    ...
    url: 'https://github.com/Kumar1201',
    btnLabel: 'View GitHub Profile',
    stats: [
      { val: '4+', lbl: 'Repositories' },
      { val: 'Python', lbl: 'Top Language' },
      { val: '2025', lbl: 'Since' }
    ],
  ...
  linkedin: {
    name: 'Kumara Swamy R',
    handle: 'kumara-swamy-r-3177b8312',
    tagline: '// Web Developer & Data Scientist',
    desc: 'Building elegant web solutions and uncovering data insights. Open to exciting opportunities & collaborations.',
    url: 'https://www.linkedin.com/in/kumara-swamy-r-3177b8312',
    btnLabel: 'View LinkedIn Profile',
    stats: [
      { val: '500+', lbl: 'Connections' },
      { val: 'India', lbl: 'Location' },
      { val: 'Open', lbl: 'To Work' }
    ],
...
function showProfilePreview(type) {
  ...
  // Inject CSS custom props for theming
  ...
  requestAnimationFrame(() => {
    requestAnimationFrame(() => {
      modal.classList.add('ppm-active');
    });
  });
...
/* ===== Hero Social Cards — Staggered Entrance Animation ===== */
